...
class CONFIG:
    ...
    dataset14_root = (
        project_root
        / "14.안면부 피부질환 이미지 합성데이터"
        / "3.개방데이터"
        / "1.데이터"
    )

    dataset14_train_img   = dataset14_root / "Training" / "01.원천데이터"
    dataset14_train_label = dataset14_root / "Training" / "02.라벨링데이터"
    dataset14_val_img     = dataset14_root / "Validation" / "01.원천데이터"
    dataset14_val_label   = dataset14_root / "Validation" / "02.라벨링데이터"
    ...
    dataset15_train_img   = dataset15_root / "Training" / "01.원천데이터"
    dataset15_train_label = dataset15_root / "Training" / "02.라벨링데이터"
    dataset15_val_img     = dataset15_root / "Validation" / "01.원천데이터"
    dataset15_val_label   = dataset15_root / "Validation" / "02.라벨링데이터"
